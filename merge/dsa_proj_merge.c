...
void select_product()
{
    ...
    for(int i=0;i<rand_freq;i++)
    {
        ...
        for(int i=0;i<num;i++)
        {
            ...
            if(rand_prod==(i+1))
            {
                ...
                bill=fopen("final_bill_merge.txt","a");
    ...
    printf("\nITEMS BOUGHT:\n");
            ...
            bill=fopen("final_bill_merge.txt","r");
...
void user_interface()
{
    ...
    if(choice==1)
    {
        ...
        FILE *ptr=fopen("usernames_merge.txt","r");
        ...
        ptr=fopen("usernames_merge.txt","r");
        ...
        ptr=fopen("passwords_merge.txt","r");
        l=0;
        ...
        //we will search this user name in the array of user names to see if it exists
        ...
        if(flag_to_denote_user==1)
        {
            ...
            if(strcmp(pass,p[index].pass)==0)
            {
                ...
                FILE *bill=fopen("final_bill_merge.txt","w");
                fclose(bill);
    ...
    else if(choice==2)
    {
        ...
        /*
        then we are creating an array to store all the user names
        and an array to store passwords corresponding to those user names.
        */
        ...
        if(flag==1)
        {
            printf("\n\nSorry but this user name belongs to another existing user!");
        ...
        else
        {
            ...
            if(strcmp(pass,confirm_pass)==0)
            {
                ...
                FILE *fp=fopen("usernames_merge.txt","a");
                FILE *fpp=fopen("passwords_merge.txt","a");
